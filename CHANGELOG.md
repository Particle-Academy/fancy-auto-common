...
Notable changes to `@particle-academy/fancy-auto-common`.
...
- **activity:** make AutoTargetKind exhaustive for all shipped surfaces
...
- fancy-auto-common — shared headless primitives for autonomous UX drivers
